...
const iop_conf_t iop_conf_tab[4][32] = {
	...
	/* PC29 */ { 1,          1,   0,   0,   0,   0 }, /* SCC1 RCLK(CLK3) */
	/* PC28 */ { 1,          1,   0,   0,   0,   0 }, /* SCC1 TCLK(CLK4) */
	/* PC27 */ { 1,          1,   0,   0,   0,   0 }, /* SCC3 TCLK(CLK5) */
	/* PC26 */ { 1,          1,   0,   0,   0,   0 }, /* SCC3 TCLK(CLK6) */
	/* PC25 */ { 1,          1,   0,   0,   0,   0 }, /* SCC4 TCLK(CLK7) */
	/* PC24 */ { 1,          1,   0,   0,   0,   0 }, /* SCC4 TCLK(CLK8) */
	/* PC23 */ {CONFIG_SYS_FCC1,1,0,   0,   0,   0 }, /* FCC1 RCLK(CLK9) */
	/* PC22 */ {CONFIG_SYS_FCC1,1,0,   0,   0,   0 }, /* FCC1 TCLK(CLK10) */
	/* PC21 */ { 1,          1,   0,   0,   0,   0 }, /* SCC2 TCLK(CLK11) */
	/* PC20 */ { 1,          1,   0,   0,   0,   0 }, /* SCC2 TCLK(CLK12) */
	...
	/* PD13 */ {   1,   0,   0,   1,   0,   0   }, /* PD13 MDIO1 */
	/* PD12 */ {   1,   0,   0,   1,   0,   0   }, /* PD12 MDC1 */
	/* PD11 */ {   1,   0,   0,   1,   0,   0   }, /* PD11 MDIO0 */
	/* PD10 */ {   1,   0,   0,   1,   0,   0   }, /* PD10 MDC0 */
